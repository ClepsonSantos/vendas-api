package com.blac.vendasapi.service;
...
public class RelatorioVendaService {
	...
	public byte[] gerarRelatorio(Long idCliente, Date dataInicio, Date dataFim) {
		try (Connection connection = dataSource.getConnection();) {
			...
			return JasperRunManager.runReportToPdf(
					relatorioVendasCompilado.getInputStream(), parametros, connection
			);
	...
	public byte[] gerarRelatorioConpilado() {
		try (
			...
			JasperPrint print = JasperFillManager.fillReport(relatorioVendasCompilado.getInputStream(), paramentros, connection);
	...
	public byte[] gerarRelatorioCompilando() {
		...
		try (
			...
			JasperPrint print = JasperFillManager.fillReport(compileReport, paramentros, connection);
